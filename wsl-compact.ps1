...
# Standardized .NET type resolution using proper dot-notation
$wid = [SystemSecurityPrincipalWindowsIdentity]::GetCurrent()
$prp = New-Object System.Security.Principal.WindowsPrincipal($wid)
$adm = [SystemSecurityPrincipalWindowsBuiltInRole]::Administrator
...
# Specifically targets your identified 300GB file path
